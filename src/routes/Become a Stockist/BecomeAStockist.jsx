...
function BecomeAStockist() {
  ...
  function next() {
    navigate('/become-a-stockist/page2')
  }
  ...
  return (
    <div className='first-parent'>
      ...
      <div className='request-to-be-a-stockist-parent'>
        ...
        <div className='contact-form-parent'>
          <div className='contact-form-left'>
            ...
            <div className='input'>
              <p>BUSINESS NAME (THIS WILL BE USED AS THE ACCOUNT NAME ON FILE)*</p>
              <input type="text" />
            </div>

            <div className='input'>
              <p>EMAIL (THIS WILL BE YOUR PRIMARY LOGIN)*</p>
              <input type="text" />
            </div>
          </div>
...
export default BecomeAStockist;