import './FindTheRightBundleDesktop.scss';
import Findtherightbundle from '../../assets/findtherightbundle.jpg'

function FindTheRightBundleDesktop () {
  return (
    <div className='find-the-right-bundle-parent'>
      <img src={Findtherightbundle} alt="Find the right bundle" />
      <div className='find-the-right-bundle-parent-overlay'>
...
export default FindTheRightBundleDesktop;